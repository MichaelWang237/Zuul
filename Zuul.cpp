...
int main() {//main method
    ...
    list[5] = new Room ("You're in the 1-20 computer lab. As the name suggests, theres are computers here.",6,"N",2,"E",7,"S",10,"W",5);
    list[6] = new Room ("You're in Mr. Schilling's room.",7,"N",3,"E",8,"S",11,"W",6);
    list[7] = new Room ("You're in Mrs. Thornewood's room.",8,"N",4,"Z",0,"S",12,"W",7);
